    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-chambray/10 bg-white p-6 shadow-xl dark:bg-chambray">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="portal-eyebrow">Profile photo</p>
            <h2
              id="avatar-crop-title"
              className={`mt-1 text-xl text-app-heading ${bricolage_grot600.className}`}
            >
              Position your photo
            </h2>
        ...
        <label className="mt-4 block text-sm text-app-heading">
