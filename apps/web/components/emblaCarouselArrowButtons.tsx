import React, {
  ...
  export const PrevButton: React.FC<PropType> = (props) => {
    ...
    return (
      <button
        className={cn(
          'group embla__button embla__button--prev hover:cursor-pointer',
      ...
      >
        <svg
          className="embla__button__svg h-[2em] w-[2em] fill-sanmarino transition-colors duration-200 group-hover:fill-casablanca group-focus-visible:fill-casablanca"
          viewBox="0 0 532 532"
          aria-hidden
        >
  ...
  export const NextButton: React.FC<PropType> = (props) => {
    ...
    return (
      <button
        className={cn(
          'group embla__button embla__button--next hover:cursor-pointer',
          disabled && 'embla__button--disabled',
          className,
        )}
        type="button"
