...
import { useGrantSocialListeningSubscriptionMutation } from '@/lib/api/mutations/social-listening'
...
export default function GrantSubscriptionForm() {
  ...
  const grantMutation = useGrantSocialListeningSubscriptionMutation()
  ...
  return (
    <form onSubmit={(e) => void onSubmit(e)} className="admin-surface max-w-xl space-y-4 rounded-2xl p-6">
      ...
      <div className="flex gap-3 pt-2">
        <button type="submit" disabled={grantMutation.isPending} className="admin-btn-primary min-h-10">
